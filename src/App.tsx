  ...
  en: {
    ...
    marketing: {
      ...
      configure: 'Configure'
        ...
        broadcast: 'Secure Email Broadcaster',
        tracking: 'Pixel & Tracking Nodes',
        automated: 'AI Optimizations'
      },
      search_placeholder: 'Search campaigns...',
      add_campaign: 'New Campaign Node',
      stats: {
        reach: 'Reach',
        engagement: 'Engagement',
        budget: 'Budget'
      ...
      cancel: 'Cancel',
      add_modal_title: 'Create Marketing Node',
      campaign_name: 'Campaign Name',
      budget_label: 'Budget (SAR)',
      date_label: 'Deployment Date',
      category_label: 'Campaign Category',
      create_campaign: 'Create Sovereign Campaign',
      total_reach: 'Total Reach',
      conv_rate: 'Conv. Rate',
      roi_multiplier: 'Marketing ROI',
      table: {
        identity: 'Campaign Identity',
        status: 'Status',
        reach: 'Market Reach',
      ...
      activate_recommendations: 'Activate Smart Recommendations',
      ...
      ai_automation_desc: 'Auto-optimize campaign budgets based on performance.',
      ...
      email_composer_title: 'Corporate Email Composer',
      email_subject_placeholder: 'Message subject...',
      email_content_placeholder: 'Message content...',
      ...
      linkedin_institutional: 'LinkedIn Institutional',
      sovereign_automation_ai: 'Sovereign Automation AI',
      ai_marketing_engine_alert: 'AI Marketing Engine Alert',
      apply_optimization_btn: 'Apply Optimization',
      last_audit_prefix: 'Last Audit:',
      secure_node_active_label: 'Secure Node Active',
      activate_campaign_btn: 'Activate Campaign',
      marketing_campaign_title: 'Marketing Campaign Title',
      transactions_automated: 'Automated Transactions',
      configure: 'Configure'
    },
    affiliate: {
      lang: 'en',
