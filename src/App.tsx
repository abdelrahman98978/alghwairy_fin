...
const translations = {
  ar: {
    ...
    invoices: {
      ...
      profit_label: 'صافي الربح',
      inventory_total: 'قيمة الشحنات',
      ...
      stats: {
        total_due: 'إجمالي الفواتير',
        collected: 'التحصيل (هذا الشهر)',
        overdue: 'متأخرات مستحقة',
        zatca_certified: 'إجمالي الرسوم الحكومية'
      },
      table: {
        number: 'رقم المرجع',
        client: 'العميل',
  ...
  en: {
    ...
    invoices: {
      ...
      stats: {
        total_due: 'Total Invoices',
        collected: 'Collected (Monthly)',
        overdue: 'Overdue Balance',
        zatca_certified: 'Total Govt Fees'
      },
      table: {
        number: 'Ref #',
        client: 'Client',
